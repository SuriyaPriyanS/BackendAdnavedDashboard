import OverallStat from "../Models/OverallStaat.js";
...
export const getMonthlySales = async (req,res) => {
    try {
        ...
        const monthlyUnitsLine = await OverallStat.aggregate([
            ...
            res.status(200).json({sales: monthlySalesLine, units: monthlyUnitsLine});
...
export const getDailySales = async (req,res) => {
    try {
        ...
        res.status(200).json({sales: dailySalesLine, units: dailyUnitsLine});
    } catch (error) {
        res.status(500).json({message: error.message});
